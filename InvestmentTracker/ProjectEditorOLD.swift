...
struct ProjectEditorOLD_Previews: PreviewProvider {
    static var previews: some View {
        ProjectEditorOLD(draft: .constant(Project.saperavi), shouldSave: .constant(true))
